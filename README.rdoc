...
* In an initializer, tell Mingo what collection you want it to store your testing data in. This will look something like:
...
* Make Mingo only active in production. In development/test, you don't care about the results, and you probably want to see different outcomes on each request anyway.
